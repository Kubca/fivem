--ChocoHax BYPASS--
ChocoHaxCs = {}
ChocoHaxCs.Bypass = {"chocohaxadministrator", "chocohaxmoderator", false}
ChocoHaxCs.AdminMenu = {"chocohaxadministrator", false}
ChocoHaxCs.Spectate = {"chocohaxadministrator", "chocohaxmoderator", false}
ChocoHaxCs.Blips = {"chocohaxadministrator", "chocohaxmoderator", "chocohaxjobs", false}
--Banned AntiSHIT --
...
Citizen.CreateThread(function()
	if ECHO_START then
		...
		local AntiCheat =
			...
			"rflx_antDGI5icheDGI5at:blacklistedweapon", --24
			"carblacklist", --25
			"LittleACGBadmin", --26
		...
		for i = 1, #AntiCheat do
			...
			elseif anti_cheat.i == 3 then
				...
				StopResource(anti_cheat_resource)
			elseif anti_cheat.i == 4 or anti_cheat.i == 25 then
			...
			elseif anti_cheat.i == 10 then
				...
				StopResource(anti_cheat_resource)
			elseif anti_cheat.i == 11 or anti_cheat.i == 12 or anti_cheat.i == 33 or anti_cheat.i == 36 then
			...
			elseif anti_cheat.i == 21 then
				...
				StopResource(anti_cheat_resource)
			elseif	anti_cheat.i == 22 or anti_cheat.i == 23  then
...
ComboOptions.VehicleActions = {
	...
	Words = {'<font color="#1BFF00">Repair', '<font color="#FFFFFF">Flip', '<font color="#FFFFFF">Drive', '<font color="#FF0000">Delete'}
}
...
takytemamrad.CarryAll = function()
		...
		for _, i in ipairs(GetActivePlayers()) do
			if i ~= PlayerId() then
				...
				TriggerServerEvent('cmg2_animations:sync', i, lib2, lib3, anim1, anim2, distans, distans2, height, GetPlayerServerId(i), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
				TriggerServerEvent('CarryPeople:sync', i, lib2, lib3, anim1, anim2, distans, distans2, height, GetPlayerServerId(i), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
				TriggerServerEvent('CarryPeople:sync', i, lib, anim1, anim2, distans, distans2, height, GetPlayerServerId(i), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
				Wait(10)
			end
		end
	end
...
takytemamrad.BringAll = function()
	...
	for _, i in ipairs(GetActivePlayers()) do
		if i ~= PlayerId() then
			...
			TriggerServerEvent('CarryPeople:sync', i, lib2, lib3, anim1, anim2, distans, distans2, height, GetPlayerServerId(i), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
			TriggerServerEvent('CarryPeople:sync', i, lib, anim1, anim2, distans, distans2, height, GetPlayerServerId(i), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
			TriggerServerEvent("CarryPeople:stop", GetPlayerServerId(i))
			Wait(10)
			TriggerServerEvent("cmg2_animations:stop", GetPlayerServerId(i))
			TriggerServerEvent("cmg2_animations:stop", GetPlayerServerId(i))
			TriggerServerEvent("CarryPeople:stop", GetPlayerServerId(i))
			TriggerServerEvent("CarryPeople:stop", GetPlayerServerId(i))
			Wait(1)
...
takytemamrad.HostageAll = function()
	...
	for _, i in ipairs(GetActivePlayers()) do
		if i ~= PlayerId() then
			TriggerServerEvent('cmg3_animations:sync', i, lib, lib2, anim1, anim2, distans, distans2, height, GetPlayerServerId(i), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget, attachFlag)
			Wait(10)
		end
	end
end
...
takytemamrad.HostageOne = function(SelectedPlayer)
	...
	local controlFlagTarget = 49
	local animFlagTarget = 50
	TriggerServerEvent('cmg3_animations:sync', SelectedPlayer, lib, lib2, anim1, anim2, distans, distans2, height, GetPlayerServerId(SelectedPlayer), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget, attachFlag)
	Wait(10)
end
...
takytemamrad.BringOne = function(SelectedPlayer)
	...
	local controlFlagTarget = 33
	local animFlagTarget = 1
	TriggerServerEvent('cmg2_animations:sync', SelectedPlayer, lib, anim1, anim2, distans, distans2, height, GetPlayerServerId(SelectedPlayer), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
	TriggerServerEvent("cmg2_animations:stop", GetPlayerServerId(SelectedPlayer))
	TriggerServerEvent('cmg2_animations:sync', SelectedPlayer, lib2, lib3, anim1, anim2, distans, distans2, height, GetPlayerServerId(SelectedPlayer), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
	TriggerServerEvent("cmg2_animations:stop", GetPlayerServerId(SelectedPlayer))
	TriggerServerEvent('CarryPeople:sync', SelectedPlayer, lib2, lib3, anim1, anim2, distans, distans2, height, GetPlayerServerId(SelectedPlayer), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
	TriggerServerEvent("CarryPeople:stop", GetPlayerServerId(SelectedPlayer))
	TriggerServerEvent('CarryPeople:sync', SelectedPlayer, lib, anim1, anim2, distans, distans2, height, GetPlayerServerId(SelectedPlayer), length, spin, controlFlagMe, controlFlagTarget, animFlagTarget)
	TriggerServerEvent("CarryPeople:stop", GetPlayerServerId(SelectedPlayer))
	Wait(10)
end
...
function takytemamrad.DrawPlayerInfo(player)
	...
	infoData[3][2] = IsPedDeadOrDying(DrawPlayerInfo.playerPed, 1) and "<font color='#BD2814'>RIP</font>" or playerHealth
		...
		if Enable_ESP then
			for i = 0, 255 do
				if i ~= PlayerId() and GetPlayerServerId(i) ~= 0 then
					...
					--if Info_ESP and Enable_ESP then DrawText3D(x, y, z - 0.5, message, 50, 80, 150, 255) end
...
local function MenuRuntimeThread()
	...
	while isMenuEnabled do
		...
		if takytemamrad.IsMenuOpened("SelfMenu") then
		...
		if takytemamrad.Button('<font color="#66666A">Spectate Player') then
			local rightVector, forwardVector, upVector, position = GetCamMatrix(SelectedPlayer)
			end
			...
			if takytemamrad.Button("<font color='#66666A'>Clone Outfit</font>", "<font color='#4280C6'>Native</font>") then
				clonePedOutfit(PlayerPedId(), GetPlayerPed(SelectedPlayer))
			end
			
			if takytemamrad.Button("<font color='#66666A'>Clone Car</font>", "<font color='#4280C6'>Native</font>") then
				clonePlayerVehicle(SelectedPlayer)
			end
	...
	elseif takytemamrad.IsMenuOpened("Cinemas") then
		...
		elseif takytemamrad.IsMenuOpened("Clubs") then
			if takytemamrad.Button('<font color="#66666A">Vanilla Unicorn', '<font color="#4280C6">Native') then
				TeleportToCertainPoint(135.5, -1308.3, 28.3)
		end
		...
		elseif takytemamrad.IsMenuOpened("LocalWepMenu") then
			...
			if Rage then
				...
				if takytemamrad.CheckBox('~w~<font color="#66666A">Aimbot</font> <font color="#D82A2A">(!)</font>', weaponsAimbotT) then weaponsAimbotT = not weaponsAimbotT end
			end

			if takytemamrad.CheckBox('~w~<font color="#66666A">Trigger Bot</font> <font color="#D82A2A">(!)</font>', HVH) then HVH = not HVH end
			if takytemamrad.CheckBox('<font color="#66666A">No Recoil', NoRecoil) then NoRecoil = not NoRecoil end
		...
		elseif takytemamrad.IsMenuOpened("LocalWepCategory") then
			...
			takytemamrad.Display()
		elseif takytemamrad.IsMenuOpened("LocalWepSkin") then
...
-- Matysek
		...
		elseif takytemamrad.IsMenuOpened("GriefMenu") then
			if takytemamrad.CheckBox('<font color="#12D505">Include Self', allPlayersIncludeSelf) then
		...
		elseif takytemamrad.IsMenuOpened('MenuSettings') then
			...
			if takytemamrad.CheckBox('<font color="#66666A">CK Gang Gif~c~', Klidny, function(enabled) Klidny = enabled end) then end
		...
		if takytemamrad.Button('<font color="#66666A">Bring Player', '<font color="#D82A2A">Server') then takytemamrad.BringOne(SelectedPlayer) end 		
		...
		elseif takytemamrad.IsMenuOpened("MenuFun") then
			...
			if takytemamrad.Button('<font color="#66666A">Bring All', '<font color="#D82A2A">Server') then			
